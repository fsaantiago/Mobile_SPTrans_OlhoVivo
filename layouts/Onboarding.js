...
export default function OnboardingCarousel() {
    ...
    const pages = [
        {
            subtitle: <Text>
                    O <Text style={styles.bold}>SPTrans - Olho Vivo</Text> é um aplicativo para facilitar seu dia a dia no uso do transporte público de São Paulo!
                </Text>,
            image: require('../assets/logos/SPTrans_logo.png'),
        },
        {
            subtitle: 'Aqui você terá informações úteis e em tempo real da sua linha de ônibus...',
            image: require('../assets/logos/SPTrans_logo.png'),
        },
    ];
            ...
            <View style={styles.contentContainer}>
                ...
                <TouchableOpacity style={styles.nextButton} onPress={handleNext}>
                    <Text style={styles.nextButtonText}>
                        {pageIndex === pages.length - 1 ? 'Prosseguir para o app' : 'Seguinte'}
                    </Text>
                </TouchableOpacity>
            </View>
        </GestureRecognizer>
